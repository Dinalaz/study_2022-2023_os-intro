...
Создаем ключи ssh (рис. [-@fig:005])

![SSH](image/keys.png){#fig:005 width=90%}

Создаем ключи pgp (рис. [-@fig:006])

![PGP](image/gpg.png){#fig:006 width=90%}

Добавление PGP ключа в GitHub(рис. [-@fig:007])
